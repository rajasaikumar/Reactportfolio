...
import saiResume from "../assets/saiResume.pdf"
      ...
      <div className="home">
        <div className="row justify-content-start  text-center min-vh-100 ">
          <div className="col-md-7 ">
            ...
            <a href="https://www.linkedin.com/in/sai-kumar-raja-ba659820b" target="_blank" rel="noopener noreferrer">
          ...
          <div className="col-md-5 d-flex flex-column align-items-center text-center">
            ...
            <div className="button-container">
              <a href={saiResume} download="Sai_Kumar_Resume.pdf" className="btn btn-primary mt-3 mx-3 download-btn">
                Download Resume
              </a>
            </div>
          </div>
